...
export const GAMES: GameBundle[] = [
  ...
  },
  {
    ...
    meta: {
      name: 'Mines',
      description: `
        There's money hidden beneath the squares. The reward will increase the more squares you reveal, but watch out for the hidden mines. Touch one and you'll go broke. You can cash out at any time.
      `,
